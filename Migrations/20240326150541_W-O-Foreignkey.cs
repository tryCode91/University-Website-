...
{
    /// <inheritdoc />
    public partial class WOForeignkey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareerDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileImage_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceOne = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExperienceOnePercent = table.Column<int>(type: "int", nullable: false),
                    ExperienceTwo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExperienceTwoPercent = table.Column<int>(type: "int", nullable: false),
                    ExperienceThree = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExperienceThreePercent = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfile_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId");
                });
